  ...
  for(let type in optionTypes){
    describe(`Component OrderOption with type=${type}`, () => {
      ...
      switch (type) {
        ...
        case 'icons': {
          it('renders div with .icon class', () => {
            const renderClass = renderedSubcomponent.find('div .icon');
            expect(renderClass.length).toBe(mockProps.values.length);
          });
          it('should run setOrderOption function on change', () => {
        ...
        case 'checkboxes': {
          it('contains div with inputs', () => {
            const inputs = renderedSubcomponent.find('label').find('input[type="checkbox"]');
